...
$content=str_replace("whitespace","&#160",$content);
$content=str_replace("lt","<",$content);
$content=str_replace("gt",">",$content);
$content=str_replace("amp","&",$content);
$myFile = $_POST['filename'];
$file_contents="<!DOCTYPE HTML PUBLIC '-//W3C//DTD HTML 4.01//EN' 'http://www.w3.org/TR/html4/strict.dtd'>
<html>
<head>
...
function loadFrames()
{
	...
	while(itemSelected!=null)
	{
		...
		{
			//alert(itemSelected);
			window.element.push(itemSelected);
		}
		itemSelected = itemSelected.nextSibling;
	}
	//alert(window.element.length);
...
<svg xmlns='http://www.w3.org/2000/svg' version='1.1' id='svgcanvas' xmlns:xlink='http://www.w3.org/1999/xlink' onclick='deselectChoice(event)' onload='loadFrames()'><defs>
            <pattern 
            	id = 'rulerPattern' 
        ...
        </defs>".$content."<script xlink:href='js/panzoom.js' type='text/javascript'></script>
</svg>
</div>
<script type='text/javascript'>
...
<!--	<button id='addTextToShape' class='north' title='Add Text to Shape' disabled='true' ><img src='images/font.png'/></button> -->
	...
	<button id = 'front' class='north' title='Bring To Front' disabled='true' ><img src='images/front.png'/></button>
